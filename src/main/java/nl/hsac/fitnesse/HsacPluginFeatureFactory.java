...
public class HsacPluginFeatureFactory extends PluginFeatureFactoryBase {
    ...
    public void registerSymbolTypes(SymbolProvider symbolProvider) throws PluginException {
        ...
        add(symbolProvider, new DaySymbol.Monday());
        add(symbolProvider, new DaySymbol.Tuesday());
        add(symbolProvider, new DaySymbol.Wednesday());
        add(symbolProvider, new DaySymbol.Thursday());
        add(symbolProvider, new DaySymbol.Friday());
        add(symbolProvider, new DaySymbol.Saturday());
        add(symbolProvider, new DaySymbol.Sunday());
