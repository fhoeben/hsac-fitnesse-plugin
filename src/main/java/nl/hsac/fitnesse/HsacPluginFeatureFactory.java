...
public class HsacPluginFeatureFactory extends PluginFeatureFactoryBase {
    ...
    public void registerSymbolTypes(SymbolProvider symbolProvider) throws PluginException {
        ...
        add(symbolProvider, new Monday());
        add(symbolProvider, new Tuesday());
        add(symbolProvider, new Wednesday());
        add(symbolProvider, new Thursday());
        add(symbolProvider, new Friday());
        add(symbolProvider, new Saturday());
        add(symbolProvider, new Sunday());
